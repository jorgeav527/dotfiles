...
return function(capabilities)
	...
	local ruff_linter = require("efmls-configs.linters.ruff") -- python linter
	local ruff_format = require("efmls-configs.formatters.ruff") -- python formatter
	local ruff_sort = require("efmls-configs.formatters.ruff_sort") -- python formatter
	...
	local goimports = require("efmls-configs.formatters.goimports") -- go formatter
	...
	vim.lsp.config("efm", {
		...
		settings = {
			languages = {
				...
				go = { go_revive, goimports, gofumpt },
				html = { prettier_d },
				...
				lua = { luacheck, stylua },
				markdown = { prettier_d },
				python = { ruff_linter, ruff_sort, ruff_format },
				sh = { shellcheck, shfmt },
